                ...
                <div className="-mt-7.5">
                    <div className="w-full flex flex-row justify-between flex-wrap">
                        {tvPopularDatas.map((item)=>(
                            <MovieBox key={item.id} poster={item.poster_path} title={item.name} id={`/tv/${item.id}`} date={item.first_air_date} rating={item.vote_average} description={item.overview}/>
                        ))}
