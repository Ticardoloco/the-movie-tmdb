      ...
      <div className="w-full flex items-center ">
        ...
        <div className="w-full ">
            ...
            <div className="flex items-center mt-0.5 ">
                <div className="flex items-center p-[0_8px_0_6px] font-semibold bg-[rgba(3,37,65,1)] justify-center text-white border-solid border border-[rgba(3,37,65,1)] rounded-md overflow-hidden text-[14.4px] mr-2 ">
