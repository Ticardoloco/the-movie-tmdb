        ...
        <div className=" bg-[rgba(0,0,0,.15)] rounded-lg ">
          <div className="w-full h-9.5 bg-[rgba(0,0,0,.2)] rounded-tl-lg rounded-tr-lg ">
            <div className="w-full border-[rgba(220.5,220.5,220.5,1)] bg-[rgba(220.5,220.5,220.5,1)] text-black flex items-center h-full overflow-visible p-[0_12px] border-br-0 border-bl-0 rounded-tl-lg rounded-tr-lg">
              <p className="mb-0 text-black font-bold text-base p-0 flex flex-wrap m-0 whitespace-nowrap ">
                {score}
              </p>
            </div>
          </div>
          ...
          <div className="w-full h-11.25 mb-5 flex items-center ">
            <div className="w-11.25 h-11.25 ">
              <Link
                ...
                className="inline-block w-11.25 h-11.25 text-black font-normal"
              >
                <span className="w-11.25 h-11.25 flex items-center justify-center text-center uppercase text-white text-[19.2px] font-normal rounded-full bg-[rgba(210,114,1,1)]">
                  M
                </span>
              </Link>
            </div>
