...
const Page = () => {
  ...
  return (
    <div className='w-full flex justify-center flex-wrap items-start bg-cover bg-no-repeat bg-position-[50%_50%] '>
      <ShortcutBar/>
      <div className="hidden lg:block mt-27.5 border-b border-solid border-[rgb(220.5,220.5,220.5)] bg-position-[left_calc((50vw-170px)-340px)_top] bg-cover bg-no-repeat w-full relative z-1 bg-[linear-gradient(to_bottom_right,rgba(221,221,221,1),rgba(221,221,221,0.84))] border" style={{backgroundImage:`url(${TMDB_IMAGE_BASE}${size}${movieDetailDatas?.backdrop_path})`}}>
